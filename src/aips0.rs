...
#[doc = "Peripheral Access Control Register"]
pub mod pacrp;
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about avaliable fields see [pacru](pacru) module"]
pub type PACRU = crate::Reg<u32, _PACRU>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _PACRU;
#[doc = "`read()` method returns [pacru::R](pacru::R) reader structure"]
impl crate::Readable for PACRU {}
#[doc = "`write(|w| ..)` method takes [pacru::W](pacru::W) writer structure"]
impl crate::Writable for PACRU {}
#[doc = "Peripheral Access Control Register"]
pub mod pacru;
