...
#[doc = "Possible values of the field `UART5`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum UART5R {
    #[doc = "Clock disabled"]
    _0,
...
impl UART5R {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> UART5R {
        match value {
            false => UART5R::_0,
            true => UART5R::_1,
        }
...
#[doc = "Values that can be written to the field `UART5`"]
pub enum UART5W {
    #[doc = "Clock disabled"]
    _0,
    #[doc = "Clock enabled"]
...
#[doc = r" Proxy"]
pub struct _UART5W<'a> {
    w: &'a mut W,
}
impl<'a> _UART5W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: UART5W) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(UART5W::_0)
    }
    #[doc = "Clock enabled"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(UART5W::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
